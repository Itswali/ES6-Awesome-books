...
class DateTime {
  ...
  /**
        ...
        * @param {string} unit - The unit to go to the end of. Can be 'year', 'quarter', 'month', 'week', 'day', 'hour',
  ...
  /**
        ...
        * **You may not want this.** See {@link DateTime#toLocaleString} for a more flexible formatting tool.
  ...
  /**
        * {@link DateTime#toLocaleString} format like 'Friday, October 14,
        * 1983, 9:30 AM Eastern Daylight Time'. Only 12-hour if the locale is.
        * @type {Object}
        */
  ...
  /**
        * {@link DateTime#toLocaleString} format like 'Friday, October 14, 1983, 9:30:33 AM Eastern
